...
def test_new_contact(app):
        ...
        contact = Contact(firstname = "Ada", middlename = "dad", lastname = "Rad",
                 nickname = "Red", title = "hfkkfd", company = "fgdds", address = "shnat fjndj 8", homephone = "89253748",
                 mobilephone = "34567766", workphone = "44444", fax = "3324", email = "wweiehhc@kjdnd",bday = "15", bmonth = "August",
                 byear = "1991", aday = "14", amonth = "November", ayear = "2302", address2 = "jdskflvbm,c78",
                 secondaryphone = "jdsk48309", notes = "hfkdn")
